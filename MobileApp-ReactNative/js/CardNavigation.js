    ...
    get prevButton () {
        ...
        return (
            <TouchableOpacity style={styles.prevButtonContainer} onPress={this.showPrev}>
                <Text  style={{color:'#e7e7e7',fontWeight:'bold',fontSize:width/15}}>Geri</Text>
            </TouchableOpacity>
        );
    }
    ...
    get nextButton () {
        ...
        return (
            <TouchableOpacity style={styles.nextButtonContainer} onPress={this.showNext}>
                <Text style={{color:'#e7e7e7',fontWeight:'bold',fontSize:width/15}}>Devam </Text>
            </TouchableOpacity>
        );
    }
